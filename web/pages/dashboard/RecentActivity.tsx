...
import { List, Button, Typography, Input, Select, Pagination, Tag } from "antd";
import {
  HistoryOutlined,
  StarOutlined,
  StarFilled,
...
const getActionConfig = (action: string) => {
  const configMap: {
    ...
    SAVE_BOOKMARK: {
      ...
      description: "A new bookmark has been successfully saved",
    },
    SAVE_BOOKMARK_FAILED: {
      ...
      description: "Failed to save the bookmark",
    },
    SAVE_ALL_BOOKMARKS: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: "All Bookmarks Saved",
      description: "All Bookmark has been successfully saved",
    },
    SAVE_ALL_BOOKMARKS_FAILED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Save All Bookmarks Failed",
      description: "Failed to save All Bookmarks",
    },
    GET_BOOKMARKS_FAILED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Get Bookmarks Failed",
    ...
    BOOKMARK_DELETE_FAILED: {
      ...
      description: "Failed to delete the Bookmark",
    },
    BOOKMARK_DELETE: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
    ...
    BOOKMARK_FAVORITE_FAILED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Bookmark Favorite Failed",
      description: "Bookmark Favorite Failed",
    },
    BOOKMARK_FAVORITE_TOGGLED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Bookmark Toggled as Favorite ",
      description: "Bookmark Toggled as Favorite Successfully",
    },
    BOOKMARK_SHARE_FAILED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Bookmark Share Failed ",
      description: "Failed to Share Bookmark",
    },
    BOOKMARK_SHARE_PARTIAL: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: "Failed to send B",
      description: "Failed to send bookmark to some recipients",
    },
    BOOKMARK_SHARED: {
      icon: <BookmarkPlus />,
      color: "#d20b18ff",
      bg: "#feffffff",
      title: " Bookmark Shared Succesfully ",
      description: "Bookmark shared with all recipients successfully",
    },
    GET_CONNECTED_ACCOUNTS_FAILED: {
      icon: <GoogleOutlined />,
      color: "#44ccd3ff",
      bg: "#feffffff",
      title: " Get Connected Accounts Failed ",
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <HistoryOutlined style={{ color: "#6b7280", fontSize: "14px" }} />
            Recent Activity
          </Title>
          <Button
            type="link"
      ...
      <div style={{ padding: "24px" }}>
        ...
        {filteredActivities && filteredActivities.length === 0 && (
          ...
          >
            ...
            <div>
              <Text
                style={{ fontSize: "18px", color: "#595959", fontWeight: 600 }}
              >
                No activities found
              </Text>
              <br />
