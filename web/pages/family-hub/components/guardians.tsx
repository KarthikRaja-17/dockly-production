    ...
    async function fetchData() {
      ...
      if (userId) {
        ...
        if (res.status === 1) {
          ...
          const formattedBeneficiaries = res.payload.map(
            (beneficiary: any) => ({
              ...beneficiary,
              updated: new Date(beneficiary.updated).toLocaleDateString(
                "en-US",
                {
                  month: "2-digit",
                  day: "2-digit",
      ...
      <Row gutter={[16, 16]} style={{ marginBottom: "20px" }}>
        <Col span={12}>
          <Card style={cardStyle} hoverable>
            ...
            >
              Guardians can access specific areas of your Dockly account in case
              of emergency. Configure their access levels based on your needs.
            </Paragraph>
          </Card>
        </Col>
        <Col span={12}>
        ...
        <Col span={12}>
          <Card style={beneficiaryCardStyle} hoverable>
            ...
            >
              <Title
                level={4}
                style={{ margin: 0, fontSize: "18px", fontFamily: FONT_FAMILY }}
              >
      ...
      >
            ...
            try {
              ...
              if (editingBeneficiary) {
                await updateBeneficiary({
                  beneficiary: { ...beneficiary, id: editingBeneficiary.id },
                });
              } else {
              ...
              showNotification(
                "Error",
                "Failed to add/update beneficiary",
                "error"
              );
            }
          }}
        ...
        >
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter account/policy name" },
            ]}
          >
            <Input
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please enter primary beneficiary" },
            ]}
          >
            <Input
