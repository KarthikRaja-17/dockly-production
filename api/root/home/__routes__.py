...
home_api.add_resource(ShareMaintenanceTask, "/share/maintenance_task")
...
home_api.add_resource(AddKeyContact, "/add/key-contact")
home_api.add_resource(GetKeyContacts, "/get/key-contacts")
home_api.add_resource(UpdateKeyContact, "/update/key-contact/<string:contact_id>")
home_api.add_resource(DeleteKeyContact, "/delete/key-contact/<string:contact_id>")